...
const complete: EventConfiguration = {
	event: { id: "event", name: "Conference", timezone: "Asia/Singapore", start_day: "2026-09-01", end_day: "2026-09-02", day_start_minutes: 540, day_end_minutes: 1080, slot_duration_minutes: 30, track_conflict_policy: "hard", notify_on_submission_create: 1, notify_on_submission_update: 0, contact_email: "contact@example.test", owner_email: "owner@example.test" },
