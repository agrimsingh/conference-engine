	...
	return (
		<div className="min-h-dvh bg-neutral-950 text-neutral-200">
			...
			<main className="mx-auto max-w-4xl px-4 py-10">
				<PageHeader eyebrow="Organizer integration" title="Accelevents sync" description="Keep your Accelevents event in sync with speakers and sessions from this programme." />
